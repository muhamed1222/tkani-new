          ...
          <div className="flex items-center gap-[10px]">
            ...
            <div className="relative hidden lg:inline-block">
              <button
                ...
                className="flex items-center gap-[6px] px-[12px] py-[8px] bg-[#9B1E1C] text-white rounded-[8px] text-[16px] font-medium leading-[1.2] hover:bg-[#860202] transition-colors whitespace-nowrap"
              >
                Каталог
