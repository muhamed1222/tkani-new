...
export const AdminProducts = () => {
  ...
  }, [currentPage, perPage, searchQuery, filterCategory, filterStock]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      logger.error("Ошибка сохранения товара:", err);
    }
  };
  ...
  const handleDelete = async (productId) => {
    ...
    try {
      ...
      logger.error("Ошибка удаления товара:", err);
    }
  };
  ...
  const getImageUrl = (imagePath) => {
    ...
    return `${strapiUrl}/static/products/${imagePath}`;
  };
