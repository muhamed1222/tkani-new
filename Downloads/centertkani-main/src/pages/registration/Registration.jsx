...
export let Registration = observer(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    const middleNameValidationError = validateMiddleName(middleName);
    ...
    if (middleNameValidationError) {
      setMiddleNameError(middleNameValidationError);
      return;
    }
    ...
    logger.log('🎯 ДАННЫЕ ДЛЯ РЕГИСТРАЦИИ:', {
